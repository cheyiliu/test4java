...
public class ManagedDevice {
    ...
    public void updateGPSStatus() {
        snmpMessenger.sendGetRequest(new OID(new int[] {
                1, 3, 6, 1, 4, 1, 12619, 1, 3, 3, 0
        }), new SNMPResponseListener() {

            public void onSNMPResponseReceived(Vector<? extends VariableBinding> variableBinding) {
                setGpsStatus(variableBinding.get(0).toValueString().equalsIgnoreCase("1") ? "ON"
                        : "OFF");
            }
        });
    }
    ...
    public void updateNetworkStatus() {
        snmpMessenger.sendGetRequest(new OID(new int[] {
                1, 3, 6, 1, 4, 1, 12619, 1, 3, 5, 0
        }), new SNMPResponseListener() {

            public void onSNMPResponseReceived(Vector<? extends VariableBinding> variableBinding) {
                setNetworkStatus(variableBinding.get(0).toValueString().equalsIgnoreCase("1") ? "ON"
                        : "OFF");
            }
        });
    }
    ...
    public void updateBluetoothStatus() {
        snmpMessenger.sendGetRequest(new OID(new int[] {
                1, 3, 6, 1, 4, 1, 12619, 1, 3, 4, 0
        }), new SNMPResponseListener() {

            public void onSNMPResponseReceived(Vector<? extends VariableBinding> variableBinding) {
                setBluetoothStatus(variableBinding.get(0).toValueString().equalsIgnoreCase("1") ? "ON"
                        : "OFF");
            }
        });
    }
    ...
    public void updateBatteryStatus() {
        snmpMessenger.sendGetRequest(new OID(new int[] {
                1, 3, 6, 1, 4, 1, 12619, 1, 3, 1, 0
        }), new SNMPResponseListener() {

            public void onSNMPResponseReceived(Vector<? extends VariableBinding> variableBinding) {
                setBatteryStatus(variableBinding.get(0).toValueString().equalsIgnoreCase("1") ? "Charging"
                        : "Discharging");
            }
        });
    }
    ...
    public void updateBatteryLevel() {
        snmpMessenger.sendGetRequest(new OID(new int[] {
                1, 3, 6, 1, 4, 1, 12619, 1, 3, 2, 0
        }), new SNMPResponseListener() {

            public void onSNMPResponseReceived(Vector<? extends VariableBinding> variableBinding) {
                setBatteryLevel(variableBinding.get(0).toValueString() + "%");
                System.out.println(variableBinding.get(0).toValueString() + "%");
            }
        });
    }
    ...
    public void sendMessage(String message) {
        snmpMessenger.sendSetRequest(new OID(new int[] {
                1, 3, 6, 1, 4, 1, 12619, 1, 4, 1, 0
        }), message, new SNMPResponseListener() {
