...
// modified from FTPClientExample http://commons.apache.org/proper/commons-net/examples/ftp/FTPClientExample.java
...
//            ftp.setUseEPSVwithIPv4(useEpsvWithIPv4);
            ...
            {
                ftp.makeDirectory("/to_be_deleted/data/123");
                ftp.changeWorkingDirectory("/to_be_deleted/data/123");
            }
          String local = "/home/housy/桌面/123/system_app_crash@1412821524218.txt";
          String remote = System.currentTimeMillis() + "system_app_crash@1412821524218.txt";
          InputStream input;
